...
= 1.1.0 =
* Feature - Add option to change the slug of archive page.
* Fix - In Simple Folio plugin alt text is not suitable in case of no image
...
== Upgrade Notice ==
= 1.1.0 =
1.1.0 is a major release with option to change the slug of archive page.
